...
func _ready():
	...
	text_queue("No protoboard, ajeite aquele circuito para ele funcionar, se ele funcionar, te devolvo a bateria!", 1)
	...
	text_queue("Clique no botão junto ao protoboard para testar o circuito.", 1)
