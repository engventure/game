...
func _ready():
	...
	text_queue("Poxa agora fiquei curioso...", 2)
	text_queue("Mas estou muito feliz com a bateria carregada! Muito obrigado, Galinha, me salvou!", 2)
	...
	text_queue("Caramba! Estou indo agora mesmo! Obrigado por tudo, Galinha!", 2)
