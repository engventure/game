...
func _ready():
	...
	hide_icon3()
	hide_texbox()
	text_queue("Parece que você conseguiu, Macaco, parabéns!", 1)
	text_queue("Valeu! Não foi fácil!", 2)
	text_queue("Continue a buscar suas peças pelas arenas a seguir, logo logo você consertará seu carro", 1)
