...
func _ready():
	...
	text_queue("Aquela sala tem todas as peças e motores que os Engenheiros Automotivos precisam para dar vida a um automóvel!", 1)
	text_queue("Aquela sala é incrivel! Também tem muitos troféus de corrida hehehe", 1)
	text_queue("Que legal, posso ver?", 2)
	text_queue("É uma pena, mas só engenheiros automotivos podem entrar, regras são regras!", 1)
	text_queue("Que tal se tornar um?", 1)
	text_queue("Vou pensar no assunto, haha! Obrigado mais uma vez, Gato! Até a próxima!", 2)
